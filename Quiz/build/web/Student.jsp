...
<%
    try{
		    ...
		    conn1 = DriverManager.getConnection(url,"app","app");
		    System.out.println("Connection established with Database1");
		    stmt1 = conn1.createStatement();
		    //Creating the query
		    usr=request.getParameter("username");
		    pwd=request.getParameter("password");
		    String query1 = "SELECT password FROM quiz Where username=\'"+usr+"\'";
		    ...
		    else
		    {
		    	...
		    	out.println("<form action=\"index.html\" method=\"POST\"><input type=\"submit\" value=\"GO TO HOME PAGE\"></form>");
		    }
